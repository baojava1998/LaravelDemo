                        ...
                        @foreach($theloai as $tl)
                            @if(count($tl->loaitin)>0)
                                ...
                                <div class="row-item row">
                                    ...
                                    $tin1 = $data->shift();//shift lay ra 1 tin tra về kiểu mảng
                                    ?>
                                    <div class="col-md-8 border-right">
                                        <div class="col-md-5">
                                            <a href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">
                                            <img width="320px" class="img-responsive" src="upload/tintuc/{{$tin1['Hinh']}}" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="tintuc/{{$tintuc['id']}}/{{$tintuc['TieuDeKhongDau']}}.html">                                            
                                            <h4>
                                                <span class="glyphicon glyphicon-list-alt"></span> {{$tintuc['TieuDe']}}
                                            </h4>                                            
                                        </a>
                                        @endforeach
                                    </div>
